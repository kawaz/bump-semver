...
|---|---|---|---|---|
| 2026-07-29 | bug | open | [justfile-on-success-release-list-help-broken](./2026-07-29-justfile-on-success-release-list-help-broken.md) | justfile の on-success-release の --list 説明が複数行コメントの継ぎ足しで崩れている |
