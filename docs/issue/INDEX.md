...
|---|---|---|---|---|
| 2026-07-31 | bug | open | [vcs-commit-allow-nonexistent-path-hint-drops-deletions](./2026-07-31-vcs-commit-allow-nonexistent-path-hint-drops-deletions.md) | vcs commit の --allow-nonexistent-path ヒントに従うと削除 path が黙って捨てられる |
