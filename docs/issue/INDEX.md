...
|---|---|---|---|---|
| 2026-06-29 | design | open | [release-yml-sha256sums-canonical](./2026-06-29-release-yml-sha256sums-canonical.md) | release.yml canonical pattern に SHA256SUMS 添付を組み込む提案 |
| 2026-06-27 | request | open | [qq-flag-quiet-all-formal](./2026-06-27-qq-flag-quiet-all-formal.md) | -qq の挙動を help / docs に formal 化 (現状 undocumented alias) |
| 2026-06-27 | request | open | [vcs-promote-ancestor-guard](./2026-06-27-vcs-promote-ancestor-guard.md) | promote ガード追加 (祖先に default branch が居ない時) |
| 2026-06-27 | request | open | [vcs-get-default-branch-path](./2026-06-27-vcs-get-default-branch-path.md) | vcs get default-branch-path 追加 |
