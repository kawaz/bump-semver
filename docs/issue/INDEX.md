...
|---|---|---|---|---|
| 2026-07-06 | bug | open | [commit-id-jj-default-rev-points-to-working-copy](./2026-07-06-commit-id-jj-default-rev-points-to-working-copy.md) | vcs get commit-id の jj デフォルト rev が @ (mutable working copy) を指し、git HEAD と概念不一致 |
| 2026-06-29 | bug | open | [vcs-diff-excludes-position-after-double-dash-ignored](./2026-06-29-vcs-diff-excludes-position-after-double-dash-ignored.md) | vcs diff の --excludes を -- の後ろに置くと positional path 扱いされ exclude が無効化される |
