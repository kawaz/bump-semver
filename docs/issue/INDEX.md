...
|---|---|---|---|---|
| 2026-07-11 | design | open | [vcs-get-repo-root-getter-missing](./2026-07-11-vcs-get-repo-root-getter-missing.md) | vcs get に「本体リポの root/名前」を返す getter が無く、git linked worktree で repo 名が化ける |
